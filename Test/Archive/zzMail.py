...
sender_add='devautowayne@gmail.com' #storing the sender's mail id
receiver_add='wpwertz@gmail.com' #storing the receiver's mail id
password='mrxntmwqnpqolowe' #storing the password to log in
